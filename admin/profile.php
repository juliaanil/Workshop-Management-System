...
<br><br>
              ...
              <tr>
                ...
                <td> <?php if($row["manager_dol"]==NULL ){?>  <a class="btn btn-info btn-fill" href="updateprofile.php?requestid=<?php echo $row["admin_id"];?>" onclick="return confirm('Are you sure you want to update your profile?');">Update </a><?php } else {echo " - ";}?></td>
