	...
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if(isset($_POST['submit'])) {
			...
			if($email != "" && $pass != "") {
				...
				$verify = $db->query("SELECT * FROM staff_tb WHERE staff_email='$email' AND staff_password='$pass' LIMIT 1");
				...
				if($verify->num_rows) {
					...
					$_SESSION['staffemail']=$row['staff_email'];
...
<div class="login_wrapper">
	...
	<div class="login_holder">
		...
		<form method="post" action="index.php">
			...
			<div class="header">
				<h4 style="border-bottom: 1px solid #CC0000;" class="title">Staff Login</h4>
			</div>
			...
			<input type="submit" name="submit" value="Login" class="btn btn-info btn-fill pull-right" style="background: #339966; border-color: #000000;" />
