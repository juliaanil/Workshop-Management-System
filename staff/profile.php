...
<br><br>
                                ...
                                <?php
                                $sql1="select * from staff_tb,manager_tb where staff_tb.mgr_id=manager_tb.manager_id and staff_tb.staff_id='".$_SESSION["staffid"]."'";
              ...
              <tr>
                ...
                <td> <?php if($row["staff_dol"]==NULL ){?>  <a class="btn btn-info btn-fill" href="updateprofile.php?requestid=<?php echo $row["staff_id"];?>" onclick="return confirm('Are you sure you want to update your profile?');">Update </a><?php } else {echo " - ";}?></td>
