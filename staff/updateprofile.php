<?php 
    ...
    { while($row1 =$result1->fetch_assoc())
    {
       ...
       $address=$row1['staff_address'];
        $phone=$row1['staff_phone'];
        $email=$row1['staff_email'];
        $password=$row1['staff_password'];
	 ...
	 if (  isset ( $_POST["update"]))
	  {
		  ...
		  { 
			...
			$sql = "UPDATE staff_tb SET staff_address='".$_POST["address"]."',staff_phone='".$_POST["phone"]."',staff_email='".$_POST["email"]."',staff_password='".$_POST["password"]."' where staff_id='".$_GET["requestid"]."'";
