                                ...
                                <!-- <div class="col-md-12"> -->
                                            ...
                                            <div class="form-group">
                                             <div class="search"> 
                                                ...
                                                <!-- <label style="color: #333">Search</label> -->
                                                <select name="partstatus" class="mdb-select md-form" required />
...
<br><br>
                                ...
                                $sql1="select * from part_tb,staff_tb,operation_tb,work_tb,cust_tb where staff_tb.staff_id=part_tb.staff_id and operation_tb.operation_id=part_tb.partoperation_id and work_tb.work_id=part_tb.work_id and staff_tb.staff_id='".$_SESSION["staffid"]."' and part_assign='Yes' and cust_tb.cust_id=work_tb.cust_id and part_status='".$_POST["partstatus"]."'";
