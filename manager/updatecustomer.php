<?php 
	...
	$sql1="select * from cust_tb where cust_id='".$_GET['requestid']."'";
	 ...
	 if (  isset ( $_POST["update"]))
	  {
		  ...
		  { 
			...
			$sql = "UPDATE cust_tb SET cust_address='".$_POST["address"]."',cust_phone='".$_POST["phone"]."' where cust_id='".$_GET["requestid"]."'";
			if($db->query($sql) == TRUE)
			{ ?> <script> alert("Customer Details Updated Successfully!!"); 
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">UPDATE CUSTOMER</a>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" autofocus name="phone" class="form-control" placeholder="Enter Phone number" required value="<?php echo $phone; ?>"/>
                                            </div>
                                        </div>
