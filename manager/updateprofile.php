<?php 
    ...
    { while($row1 =$result1->fetch_assoc())
    {
       ...
       $address=$row1['manager_address'];
        $phone=$row1['manager_phone'];
        $email=$row1['manager_email'];
        $password=$row1['manager_password'];
	 ...
	 if (  isset ( $_POST["update"]))
	  {
		  ...
		  { 
			...
			$sql = "UPDATE manager_tb SET manager_address='".$_POST["address"]."',manager_phone='".$_POST["phone"]."',manager_email='".$_POST["email"]."',manager_password='".$_POST["password"]."' where manager_id='".$_GET["requestid"]."'";
